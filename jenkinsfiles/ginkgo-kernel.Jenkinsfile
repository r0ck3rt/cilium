            ...
            steps {
                ...
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:ccd8a5a6b7d5d44a4153e32cdafdd83684f87379@sha256:747cec1d065ceff8a4267556a012d5792c3ec44b4baf4031e95e23ae6299d462"
                    }
                }
            }
        }
